  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center z-10">
        <div className="text-center text-white">
          ...
          >
            ...
            <p className="text-lg md:text-xl opacity-90 tracking-wide">
      ...
      <button
        ...
        className="absolute left-6 top-1/2 -translate-y-1/2 z-10 p-4 rounded-full bg-white/10 backdrop-blur-md hover:bg-white/20 transition-all duration-300 disabled:opacity-50 border border-white/20"
      >
      ...
      <button
        onClick={nextSlide}
        disabled={isAnimating}
        className="absolute right-6 top-1/2 -translate-y-1/2 z-10 p-4 rounded-full bg-white/10 backdrop-blur-md hover:bg-white/20 transition-all duration-300 disabled:opacity-50 border border-white/20"
      >
